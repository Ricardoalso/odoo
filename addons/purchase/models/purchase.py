...
class PurchaseOrder(models.Model):
    ...
    def _add_supplier_to_product(self):
        ...
        for line in self.order_line:
            ...
            partner = self.partner_id.commercial_entity_id
            if (line.product_id
                    and partner not in line.product_id.seller_ids.name.commercial_entity_id
                    and len(line.product_id.seller_ids.name.commercial_entity_id) <= 10):

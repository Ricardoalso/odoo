...
class PaymentISR(common.TransactionCase):
    ...
    def _load(self, module, *args):
        tools.convert_file(self.cr, 'l10n_ch',
    ...
    def create_supplier_invoice(self, supplier, ref, currency_to_use='base.CHF', inv_date=None):
        ...
        invoice = self.env['account.invoice'].with_context(default_type='out_invoice').create({
            'type': 'in_invoice',
            'reference': ref,
    ...
    def test_payment_isr_grouping(self):
        ...
        # inv_ref.reference = '120000000000234478943216899'
        # invoices |= inv_ref
        ...
        expected_vals = [
            ...
            ('120000000000234478943216899', self.supplier_isrb1.id, 1, 42.0),
            ...
            ('{} 5678 1234'.format(inv_no_ref.move_name), self.supplier_iban.id, 3, 126.0),
        ]
        self.assertEqual(

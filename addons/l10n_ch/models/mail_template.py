    ...
    def generate_email(self, res_ids, fields):
        ...
        if self.model == 'account.move':
            for record in self.env[self.model].browse(res_ids):
                ...
                if 'l10n_ch.l10n_ch_isr_report' not in skip_reports and record.l10n_ch_isr_valid:
                ...
                if record.move_type == 'out_invoice' and 'l10n_ch.l10n_ch_qr_report' not in skip_reports and record.partner_bank_id._eligible_for_qr_code('ch_qr', record.partner_id, record.currency_id):
